...
function Whatsapp() {
    return (
        <div id='whatsapp'>
            <a href='https://t.me/nooor4k' target='_blank' id='toggle1' className='whtsapp flex items-center justify-center'>
                <svg className='h-10 w-10 fill-black' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
