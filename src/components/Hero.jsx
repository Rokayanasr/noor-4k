		...
		L161.684,188.632z'
                    ...
                    <div className='flex gap-3 items-center rounded-2xl justify-center card p-4'>
                        <svg className='h-14' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512' xmlSpace='preserve'>
                            ...
                            />
                            <g fill='#ffe15a'>
                                <path d='M114.021 87.182l12.722 38.146 40.21.312c5.206.04 7.365 6.684 3.177 9.777l-32.348 23.887 12.129 38.339c1.57 4.964-4.081 9.07-8.317 6.042l-32.714-23.383-32.714 23.383c-4.235 3.027-9.887-1.079-8.317-6.042l12.129-38.339-32.348-23.887c-4.188-3.093-2.029-9.736 3.177-9.777l40.21-.312 12.722-38.146c1.649-4.939 8.635-4.939 10.282 0zM260.037 96.582l9.122 12.44 14.723-4.604c1.906-.596 3.474 1.577 2.307 3.198l-9.012 12.52 8.928 12.58c1.156 1.629-.427 3.791-2.329 3.183l-14.692-4.702-9.205 12.378c-1.192 1.603-3.738.766-3.746-1.231l-.068-15.426-14.617-4.929c-1.893-.638-1.883-3.318.013-3.944l14.65-4.831.171-15.425c.023-1.998 2.574-2.818 3.755-1.207zM204.496 59.501l15.336 1.667 6.542-13.97c.847-1.809 3.509-1.499 3.917.457l3.154 15.1 15.308 1.905c1.982.247 2.509 2.874.776 3.866l-13.387 7.665 2.919 15.147c.378 1.961-1.958 3.275-3.437 1.933l-11.427-10.363-13.504 7.457c-1.748.965-3.719-.85-2.901-2.672l6.324-14.07-11.265-10.539c-1.458-1.363-.34-3.799 1.645-3.583zM228.739 208.997l-9.122 12.44-14.723-4.604c-1.906-.596-3.474 1.577-2.307 3.198l9.012 12.52-8.928 12.58c-1.156 1.629.426 3.791 2.329 3.183l14.692-4.702 9.205 12.378c1.192 1.603 3.738.766 3.746-1.231l.068-15.426 14.617-4.929c1.892-.638 1.883-3.318-.013-3.943l-14.65-4.831-.171-15.425c-.022-1.999-2.574-2.819-3.755-1.208zM284.281 174.151l-15.336 1.667-6.542-13.97c-.847-1.809-3.509-1.499-3.917.456l-3.154 15.1-15.308 1.905c-1.982.247-2.509 2.874-.776 3.866l13.387 7.665-2.919 15.147c-.378 1.961 1.958 3.275 3.437 1.933l11.427-10.363 13.504 7.457c1.748.965 3.719-.85 2.901-2.672l-6.324-14.07 11.265-10.539c1.458-1.362.34-3.798-1.645-3.582z' />
                            </g>
                        </svg>
                        <h5>
                            <Trans i18nKey='chinese'></Trans>
                        </h5>
                    </div>
                    {/* korean */}
                    <div className='flex gap-3 items-center rounded-2xl justify-center card p-4'>
                        <svg className='h-14' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 512 512' xmlSpace='preserve'>
                            ...
                            />
                            <path
                                d='M305.008 182.532c-40.562-27.042-95.35-15.985-122.374 24.507-13.555 20.211-8.046 47.674 12.235 61.195 20.265 13.521 47.64 8.03 61.161-12.252 13.521-20.281 40.914-25.704 61.179-12.253 20.297 13.521 25.756 40.984 12.217 61.195 27.042-40.562 16.111-95.35-24.418-122.392'
                                fill='#ff4b55'
                            />
                            <path
                                d='M182.634 207.039c-13.555 20.211-8.046 47.674 12.235 61.195 20.265 13.521 47.64 8.03 61.161-12.252 13.521-20.281 40.914-25.704 61.179-12.253 20.297 13.521 25.756 40.984 12.217 61.195-27.005 40.633-81.776 51.548-122.338 24.507-40.527-27.041-51.495-81.829-24.454-122.392'
                                fill='#41479b'
                            />
                            <g fill='#464655'>
